...
//	}
	...
	public static byte[] longToBytes10(long l) {
		byte[] l2b = new byte[10];
		l2b[0] = (byte) (int) (255L & l);
		l2b[1] = (byte) (int) ((65280L & l) >> 8);
		l2b[2] = (byte) (int) ((0xff0000L & l) >> 16);
		l2b[3] = (byte) (int) ((0xff000000L & l) >> 24);
		l2b[4] = (byte) (int) ((0xff00000000L & l) >> 32);
		l2b[5] = (byte) (int) ((0xff0000000000L & l) >> 40);
		l2b[6] = (byte) (int) ((0xff000000000000L & l) >> 48);
		l2b[7] = (byte) (int) ((0xff00000000000000L & l) >> 56);
		l2b[8] = (byte) (int) (255L & l);
		l2b[9] = (byte) (int) ((65280L & l) >> 8);
		return l2b;
	}
	public static byte[] longToBytes12(long l) {
		byte[] l2b = new byte[12];
		l2b[0] = (byte) (int) (255L & l);
		l2b[1] = (byte) (int) ((65280L & l) >> 8);
		l2b[2] = (byte) (int) ((0xff0000L & l) >> 16);
		l2b[3] = (byte) (int) ((0xff000000L & l) >> 24);
		...
		l2b[8] = (byte) (int) (255L & l);
		l2b[9] = (byte) (int) ((65280L & l) >> 8);
		l2b[10] = (byte) (int) ((0xff0000L & l) >> 16);
		l2b[11] = (byte) (int) ((0xff000000L & l) >> 24);
		return l2b;
	}
